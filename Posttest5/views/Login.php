...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
  if (isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password'])){
    ...
    $query = "SELECT * FROM akunuser WHERE username='$username' AND email='$email' AND  password='$password'";
    ...
    elseif($username=='admin'&& $email=='admin@gmail.com' && $password=='admin'){
...
<head>
  <meta charset="utf-8">
  <title>PartsExpress: Sign in</title>
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        ...
        <div class="formbg-outer">
            ...
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" action="" method="POST">
                ...
                <div class="reset-pass">
                  <a href="#" onclick="alert('Belum tersedia atau belum bisa diakses')">Forgot your password?</a>
                </div>
                </div>
          ...
          <div class="footer-link padding-top--24">
            <span>Don't have an account? <a href="../views/Register.php" >Sign up</a></span>
