        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" action="DataLogin.php" method="post">
          ...
          <div class="footer-link padding-top--24">
            <span>Don't have an account? <a href="" onclick="alert('Belum tersedia atau belum bisa diakses')" >Sign up</a></span>
